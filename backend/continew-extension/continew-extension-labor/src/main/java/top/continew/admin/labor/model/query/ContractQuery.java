...
@Data
@Schema(description = "合同查询条件")
public class ContractQuery implements Serializable {

    @Serial
    private static final long serialVersionUID = 1L;

    @Schema(description = "关键字", example = "LC-2026")
    @Query(columns = {"contract_no", "contract_name"}, type = QueryType.LIKE)
    ...
    @Schema(description = "用工单位 ID", example = "1")
    @Query
