...
public interface ContractService extends BaseService<ContractResp, ContractResp, ContractQuery, ContractReq> {

    ContractResp sign(Long id);

    ContractResp renew(Long id, ContractRenewReq req);

    ContractResp terminate(Long id, ContractTerminateReq req);
}
