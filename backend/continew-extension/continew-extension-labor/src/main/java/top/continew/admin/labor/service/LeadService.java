...
public interface LeadService extends BaseService<LeadResp, LeadResp, LeadQuery, LeadReq> {

    LeadResp transitionStatus(Long id, LeadStatusTransitionReq req);

    void createFollowUp(Long id, LeadFollowUpReq req);

    List<LeadFollowUpResp> listFollowUp(Long id);
}
