...
@CrudRequestMapping(value = "/labor/attendance/record", api = {Api.PAGE, Api.GET, Api.CREATE, Api.UPDATE,
    Api.BATCH_DELETE})
public class AttendanceRecordController extends BaseController<AttendanceRecordService, AttendanceRecordResp, AttendanceRecordResp, AttendanceRecordQuery, AttendanceRecordReq> {
}
