...
@CrudRequestMapping(value = "/labor/workforce/assignment", api = {Api.PAGE, Api.GET, Api.CREATE, Api.UPDATE,
    Api.BATCH_DELETE})
public class ContractAssignmentController extends BaseController<ContractAssignmentService, ContractAssignmentResp, ContractAssignmentResp, ContractAssignmentQuery, ContractAssignmentReq> {
}
