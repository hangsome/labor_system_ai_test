...
class RolePermissionControllerTest {
  ...
  void shouldListRoles() throws Exception {
    RoleSummaryResponse role =
        new RoleSummaryResponse(
            ...
            new DataScopePolicyResponse(1L, "ALL", null));
    ...
    mockMvc
        ...
        .andExpect(jsonPath("$.data[0].dataScopePolicy.scopeType").value("ALL"));
  }
  ...
  @Test
  void shouldRejectEmptyPermissionCodes() throws Exception {
    mockMvc
        .perform(
            put("/api/admin/v1/iam/roles/1/permissions")
                .contentType(MediaType.APPLICATION_JSON)
  ...
  @Test
  void shouldGetRoleDataScope() throws Exception {
